...
class VowelModel(nn.Module):
    def __init__(self, featuresize, hiddensize, outputsize, vocab, v = 0.0): #V, so one can make the dropout themselves when called/assigning
        super().__init__()
        ...
        self.drop_layer = nn.Dropout(p=v)
        self.vocab = vocab
